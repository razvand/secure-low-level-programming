...
\title[Capitol 1]{Capitol 1}
\subtitle{Concepte de securitate}
...
\begin{frame}{Obiective ale securității}
  \begin{itemize}
    \item brad
    \item molid
    \item carpen
...
\begin{frame}{Obiective ale atacatorului}
  \begin{itemize}
    \item povestea cu limbile
  \end{itemize}
\end{frame}

\section{Principii de securitate}

\section{Concepte de securitate}

\section{Tipuri/Clase de securitate}
